...
const githubLink = (
  <a href="https://github.com/huyphan2210" target="_blank" title="Github">
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__content">
        ...
        <div className="footer__content__social-link">
          {githubLink}
          {linkedInLink}
        </div>
      </div>
      <div className="footer__copyright">
        <text>&copy; Copyright 2018 Huddle. All rights reserved.</text>
        <p>
          Challenge by{" "}
          <a
          ...
          . Coded by{" "}
          <a
            href="https://www.frontendmentor.io/profile/huyphan2210"
            target="_blank"
            title="Challenger"
          >
            Huy Phan
